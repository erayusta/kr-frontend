      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{realEstateData.number_of_units || "Belirtilmemiş"}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{realEstateData.floor_count || "Belirtilmemiş"}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{realEstateData.heating || "Belirtilmemiş"}</p>
                  </div>
                </div>
          ...
          {campaign.description && (
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-4">Kampanya Detayları</h3>
        ...
        <div className="space-y-4">
          {/* Fiyat Planları */}
          {realEstateData.price_plans && realEstateData.price_plans.length > 0 && (
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  {selectedPlan.bedroom_count && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">{selectedPlan.bedroom_count} Yatak Odası</span>
                    </div>
                  )}
                </div>
              </CardContent>
